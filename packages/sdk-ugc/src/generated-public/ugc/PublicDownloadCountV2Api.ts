...
import { PaginatedContentDownloaderResponse } from './definitions/PaginatedContentDownloaderResponse'
import { PublicDownloadCountV2$ } from './endpoints/PublicDownloadCountV2$'
...
export function PublicDownloadCountV2Api(sdk: AccelbyteSDK, args?: ApiArgs) {
  ...
  async function getDownloader_ByContentId(
    contentId: string,
    queryParams?: { userId?: string | null; limit?: number; offset?: number; sortBy?: string | null }
