...
export class PublicLikeV2$ {
  ...
  getContentsLiked(queryParams?: {
    ...
    const url = '/ugc/v2/public/namespaces/{namespace}/contents/liked'.replace('{namespace}', this.namespace)
  ...
  getLike_ByContentId(
    ...
    const params = { limit: 1000, sortBy: 'createdTime:desc', ...queryParams } as SDKRequestConfig
