...
export class UsersAdmin$ {
   ...
   */
  getUsers(queryParams?: { emailAddress?: string | null }): Promise<IResponseWithSync<UserResponseV3>> {
  ...
  /**
   * List all users that has admin role (role that has admin_role attribute set to true). The endpoint will return all admin from all namespace when called from publisher namespace. When not called from publisher namespace, the endpoint will return all admin from the path namespace.
   */
  getAdmins(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, GetUsersResponseWithPaginationV3, 'GetUsersResponseWithPaginationV3')
  ...
  createUserBan(
    ...
    return Validate.responseType(() => resultPromise, GetUserBanV3Response, 'GetUserBanV3Response')
  }
  ...
  createUserBulk(data: UserIDsRequest): Promise<IResponse<ListUserInformationResult>> {
    ...
    return Validate.responseType(() => resultPromise, ListUserInformationResult, 'ListUserInformationResult')
  }
  ...
  getUsersSearch(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, SearchUsersResponseWithPaginationV3, 'SearchUsersResponseWithPaginationV3')
   ...
   */
  getUser_ByUserId(userId: string): Promise<IResponseWithSync<UserResponseV3>> {
    const params = {} as SDKRequestConfig
   ...
   */
  patchUser_ByUserId(userId: string, data: UserUpdateRequestV3): Promise<IResponse<UserResponseV3>> {
    const params = {} as SDKRequestConfig
    const url = '/iam/v3/admin/namespaces/{namespace}/users/{userId}'.replace('{namespace}', this.namespace).replace('{userId}', userId)
   ...
   * action code: 10138
   */
  getAgerestrictions(): Promise<IResponseWithSync<AgeRestrictionResponseV3>> {
    const params = {} as SDKRequestConfig
    const url = '/iam/v3/admin/namespaces/{namespace}/agerestrictions'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })

    const res = () => Validate.responseType(() => resultPromise, AgeRestrictionResponseV3, 'AgeRestrictionResponseV3')
   ...
   * action code: 10122
   */
  patchAgerestriction(data: AgeRestrictionRequestV3): Promise<IResponse<AgeRestrictionResponseV3>> {
    const params = {} as SDKRequestConfig
    const url = '/iam/v3/admin/namespaces/{namespace}/agerestrictions'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.patch(url, data, { params })

    return Validate.responseType(() => resultPromise, AgeRestrictionResponseV3, 'AgeRestrictionResponseV3')
  }
  ...
  createUserSearchBulk(data: ListEmailAddressRequest): Promise<IResponse<ListUserResponseV3>> {
    ...
    return Validate.responseType(() => resultPromise, ListUserResponseV3, 'ListUserResponseV3')
  }
   ...
   */
  createBan_ByUserId(userId: string, data: BanCreateRequest): Promise<IResponse<UserBanResponseV3>> {
    const params = {} as SDKRequestConfig
    const url = '/iam/v3/admin/namespaces/{namespace}/users/{userId}/bans'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    ...
    return Validate.responseType(() => resultPromise, UserBanResponseV3, 'UserBanResponseV3')
  }
  ...
  getCodes_ByUserId(userId: string): Promise<IResponseWithSync<VerificationCodeResponse>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, VerificationCodeResponse, 'VerificationCodeResponse')
  ...
  createUserBulkPlatform(data: UserIDsRequest): Promise<IResponse<ListBulkUserPlatformsResponse>> {
    ...
    return Validate.responseType(() => resultPromise, ListBulkUserPlatformsResponse, 'ListBulkUserPlatformsResponse')
  }
   ...
   */
  updatePassword_ByUserId(userId: string, data: UserPasswordUpdateV3Request): Promise<IResponse<unknown>> {
    const params = {} as SDKRequestConfig
  ...
  getAgerestrictionsCountries(): Promise<IResponseWithSync<CountryV3ResponseArray>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, CountryV3ResponseArray, 'CountryV3ResponseArray')
  ...
  getDeletionStatus_ByUserId(userId: string): Promise<IResponseWithSync<UserDeletionStatusResponse>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, UserDeletionStatusResponse, 'UserDeletionStatusResponse')
  ...
  getPlatformsJustice_ByUserId(userId: string): Promise<IResponseWithSync<GetUserMappingArray>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, GetUserMappingArray, 'GetUserMappingArray')
  ...
  patchAgerestrictionCountry_ByCountryCode(
    ...
    return Validate.responseType(() => resultPromise, CountryV3Response, 'CountryV3Response')
  }
  ...
  /**
   * This endpoint gets user single platform account metadata. Supported platforms are same with the supported login platforms.
   */
  getMetadata_ByUserId_ByPlatformId(userId: string, platformId: string): Promise<IResponseWithSync<UserPlatformMetadata>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, UserPlatformMetadata, 'UserPlatformMetadata')
  ...
  postLinkStatu_ByUserId_ByPlatformId(
    ...
    return Validate.responseType(() => resultPromise, TokenThirdPartyLinkStatusResponse, 'TokenThirdPartyLinkStatusResponse')
  }
  ...
  getPlatformJustice_ByUserId_ByTargetNamespace(userId: string, targetNamespace: string): Promise<IResponseWithSync<GetUserMappingV3>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, GetUserMappingV3, 'GetUserMappingV3')
