...
export class RolesAdmin$ {
  ...
  createRole(data: RoleCreateV3Request): Promise<IResponse<RoleV3>> {
    ...
    return Validate.responseType(() => resultPromise, RoleV3, 'RoleV3')
  }
  ...
  getRoles_v4(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, ListRoleV4Response, 'ListRoleV4Response')
  ...
  createRole_v4(data: RoleV4Request): Promise<IResponse<RoleV4Response>> {
    ...
    return Validate.responseType(() => resultPromise, RoleV4Response, 'RoleV4Response')
  }
  ...
  getRole_ByRoleId(roleId: string): Promise<IResponseWithSync<RoleResponseV3>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, RoleResponseV3, 'RoleResponseV3')
  ...
  patchRole_ByRoleId(roleId: string, data: RoleUpdateRequestV3): Promise<IResponse<RoleResponseV3>> {
    ...
    return Validate.responseType(() => resultPromise, RoleResponseV3, 'RoleResponseV3')
  }
  ...
  getRole_ByRoleId_v4(roleId: string): Promise<IResponseWithSync<RoleV4Response>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, RoleV4Response, 'RoleV4Response')
  ...
  getAdmin_ByRoleId(roleId: string): Promise<IResponseWithSync<RoleAdminStatusResponseV3>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, RoleAdminStatusResponseV3, 'RoleAdminStatusResponseV3')
  ...
  getUsers_ByRoleId(
    ...
    const res = () => Validate.responseType(() => resultPromise, ListAssignedUsersV4Response, 'ListAssignedUsersV4Response')
  ...
  createUser_ByRoleId(roleId: string, data: AssignUserV4Request): Promise<IResponse<AssignedUserV4Response>> {
    ...
    return Validate.responseType(() => resultPromise, AssignedUserV4Response, 'AssignedUserV4Response')
  }
   ...
   */
  deleteMember_ByRoleId(roleId: string, data: RoleMembersRequestV3): Promise<IResponse<unknown>> {
    const params = {} as SDKRequestConfig
  ...
  getMembers_ByRoleId(
    ...
    const res = () => Validate.responseType(() => resultPromise, RoleMembersResponseV3, 'RoleMembersResponseV3')
  ...
  getManagers_ByRoleId(
    ...
    const res = () => Validate.responseType(() => resultPromise, RoleManagersResponsesV3, 'RoleManagersResponsesV3')
