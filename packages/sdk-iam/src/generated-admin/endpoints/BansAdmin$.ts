...
export class BansAdmin$ {
  ...
  getBans(): Promise<IResponseWithSync<BansV3>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, BansV3, 'BansV3')
  ...
  getBansReasons(): Promise<IResponseWithSync<BanReasonsV3>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, BanReasonsV3, 'BanReasonsV3')
  ...
  createBanUser(data: BulkBanCreateRequestV3): Promise<IResponse<ListBulkUserBanResponseV3>> {
    ...
    return Validate.responseType(() => resultPromise, ListBulkUserBanResponseV3, 'ListBulkUserBanResponseV3')
  }
