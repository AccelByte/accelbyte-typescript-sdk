...
export class ClientsAdmin$ {
  ...
  getClients(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, ClientsV3Response, 'ClientsV3Response')
  ...
  createClient(data: ClientCreationV3Request): Promise<IResponse<ClientV3Response>> {
    ...
    return Validate.responseType(() => resultPromise, ClientV3Response, 'ClientV3Response')
  }
  ...
  getClient_ByClientId(clientId: string): Promise<IResponseWithSync<ClientV3Response>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, ClientV3Response, 'ClientV3Response')
