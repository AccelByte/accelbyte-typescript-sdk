...
export function OAuth20V4Api(sdk: AccelbyteSDK, args?: ApiArgs) {
  ...
  async function postOauthToken(
    ...
    const $ = new OAuth20V4$(Network.create(requestConfig), namespace, useSchemaValidation)
   ...
   */
  async function postOauthHeadlesToken(data: {
   ...
   */
  async function postOauthSimultaneousLogin(
    data: {
   ...
   */
  async function postOauthAuthenticateWithLink(data: {
    client_id: string | null
    linkingToken: string | null
    password: string | null
    username: string | null
  ...
  return {
    postOauthToken,
    postOauthMfaVerify,
    postOauthHeadlesToken,
    postOauthTokenExchange,
    postOauthSimultaneousLogin,
    postOauthAuthenticateWithLink,
