...
export function OAuthApi(sdk: AccelbyteSDK, args?: ApiArgs) {
   ...
   */
  async function getOauthJwks_DEPRECATED(): Promise<JwkSet> {
    const $ = new OAuth$(Network.create(requestConfig), namespace, useSchemaValidation)
    const resp = await $.getOauthJwks_DEPRECATED()
   ...
   */
  async function postOauthToken_DEPRECATED(data: {
    ...
    const $ = new OAuth$(Network.create(requestConfig), namespace, useSchemaValidation)
    const resp = await $.postOauthToken_DEPRECATED(data)
    if (resp.error) throw resp.error
    return resp.response.data
  }
   ...
   */
  async function postOauthVerify_DEPRECATED(data: { token: string | null }): Promise<TokenResponse> {
    const $ = new OAuth$(Network.create(requestConfig), namespace, useSchemaValidation)
    const resp = await $.postOauthVerify_DEPRECATED(data)
    if (resp.error) throw resp.error
    return resp.response.data
  }
   ...
   */
  async function postOauthAuthorize_DEPRECATED(data: {
    ...
    const $ = new OAuth$(Network.create(requestConfig), namespace, useSchemaValidation)
    const resp = await $.postOauthAuthorize_DEPRECATED(data)
    if (resp.error) throw resp.error
    return resp.response.data
  }
   ...
   */
  async function postOauthRevokeUser_DEPRECATED(data: { userID: string | null }): Promise<unknown> {
    const $ = new OAuth$(Network.create(requestConfig), namespace, useSchemaValidation)
    const resp = await $.postOauthRevokeUser_DEPRECATED(data)
    if (resp.error) throw resp.error
    return resp.response.data
  }
   ...
   */
  async function postOauthRevokeToken_DEPRECATED(data: { token: string | null }): Promise<unknown> {
    const $ = new OAuth$(Network.create(requestConfig), namespace, useSchemaValidation)
    const resp = await $.postOauthRevokeToken_DEPRECATED(data)
    if (resp.error) throw resp.error
    return resp.response.data
  }
   ...
   */
  async function getOauthRevocationlist_DEPRECATED(): Promise<RevocationList> {
    const $ = new OAuth$(Network.create(requestConfig), namespace, useSchemaValidation)
    const resp = await $.getOauthRevocationlist_DEPRECATED()
    if (resp.error) throw resp.error
    return resp.response.data
  }
   ...
   */
  async function createRevokeOauth_ByUserId_DEPRECATED(userId: string): Promise<unknown> {
    const $ = new OAuth$(Network.create(requestConfig), namespace, useSchemaValidation)
    const resp = await $.createRevokeOauth_ByUserId_DEPRECATED(userId)
    if (resp.error) throw resp.error
    return resp.response.data
  }
   ...
   */
  async function postTokenOauth_ByPlatformId_DEPRECATED(
    platformId: string,
    data: { device_id?: string | null; macAddress?: string | null; platform_token?: string | null }
  ): Promise<TokenResponse> {
    const $ = new OAuth$(Network.create(requestConfig), namespace, useSchemaValidation)
    const resp = await $.postTokenOauth_ByPlatformId_DEPRECATED(platformId, data)
    if (resp.error) throw resp.error
    return resp.response.data
  }

  return {
    getOauthJwks_DEPRECATED,
    postOauthToken_DEPRECATED,
    postOauthVerify_DEPRECATED,
    postOauthAuthorize_DEPRECATED,
    postOauthRevokeUser_DEPRECATED,
    postOauthRevokeToken_DEPRECATED,
    getOauthRevocationlist_DEPRECATED,
    createRevokeOauth_ByUserId_DEPRECATED,
    postTokenOauth_ByPlatformId_DEPRECATED
  }
}
