...
export class Users$ {
   ...
   */
  createUserInputValidation(data: UserInputValidationRequest): Promise<IResponse<UserInputValidationResponse>> {
    const params = {} as SDKRequestConfig
   ...
   */
  deleteUserMePlatform_ByPlatformId_DEPRECATED(platformId: string, data: UnlinkUserPlatformRequest): Promise<IResponse<unknown>> {
    const params = {} as SDKRequestConfig
