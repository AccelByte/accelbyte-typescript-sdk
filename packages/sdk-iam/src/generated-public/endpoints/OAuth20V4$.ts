...
export class OAuth20V4$ {
  ...
  postOauthToken(
  ...
  ): Promise<IResponse<LoginQueueTicketResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.isZodEnabled, () => resultPromise, LoginQueueTicketResponse, 'LoginQueueTicketResponse')
  }
   ...
   */
  postOauthTokenExchange(data: { code: string | null; additionalData?: string | null }): Promise<IResponse<LoginQueueTicketResponse>> {
    const params = {} as SDKRequestConfig
   ...
   */
  postOauthAuthenticateWithLink(data: {
    client_id: string | null
    linkingToken: string | null
    password: string | null
    username: string | null
