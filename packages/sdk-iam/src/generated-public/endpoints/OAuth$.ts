...
export class OAuth$ {
   ...
   */
  getOauthJwks_DEPRECATED(): Promise<IResponse<JwkSet>> {
   ...
   */
  postOauthToken_DEPRECATED(data: {
   ...
   */
  postOauthVerify_DEPRECATED(data: { token: string | null }): Promise<IResponse<TokenResponse>> {
    const params = {} as SDKRequestConfig
   ...
   */
  postOauthAuthorize_DEPRECATED(data: {
   ...
   */
  postOauthRevokeUser_DEPRECATED(data: { userID: string | null }): Promise<IResponse<unknown>> {
    const params = {} as SDKRequestConfig
   ...
   */
  postOauthRevokeToken_DEPRECATED(data: { token: string | null }): Promise<IResponse<unknown>> {
    const params = {} as SDKRequestConfig
   ...
   */
  getOauthRevocationlist_DEPRECATED(): Promise<IResponse<RevocationList>> {
    const params = {} as SDKRequestConfig
   ...
   */
  createRevokeOauth_ByUserId_DEPRECATED(userId: string): Promise<IResponse<unknown>> {
    const params = {} as SDKRequestConfig
