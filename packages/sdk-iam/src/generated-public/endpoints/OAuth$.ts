...
export class OAuth$ {
   ...
   */
  postOauthVerify(data: { token: string | null }): Promise<IResponse<TokenResponse>> {
    const params = {} as SDKRequestConfig
   ...
   */
  postOauthRevokeUser(data: { userID: string | null }): Promise<IResponse<unknown>> {
    const params = {} as SDKRequestConfig
   ...
   */
  postOauthRevokeToken(data: { token: string | null }): Promise<IResponse<unknown>> {
    const params = {} as SDKRequestConfig
   ...
   */
  createRevokeOauth_ByUserId(userId: string): Promise<IResponse<unknown>> {
    const params = {} as SDKRequestConfig
  ...
  postTokenOauth_ByPlatformId(
    ...
    const params = {} as SDKRequestConfig
    const url = '/iam/oauth/namespaces/{namespace}/platforms/{platformId}/token'
