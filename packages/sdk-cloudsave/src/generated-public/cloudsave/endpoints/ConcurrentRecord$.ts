...
import { PlayerRecordConcurrentUpdateResponse } from '../definitions/PlayerRecordConcurrentUpdateResponse.js'
...
export class ConcurrentRecord$ {
  ...
  updateConcurrentRecord_ByUserId_ByKey(
    ...
    return Validate.responseType(() => resultPromise, PlayerRecordConcurrentUpdateResponse, 'PlayerRecordConcurrentUpdateResponse')
  }
