...
export function PublicPlayerRecordApi(sdk: AccelbyteSDK, args?: ApiArgs) {
   ...
   */
  async function deleteRecord_ByUserId_ByKey(key: string, userId: string): Promise<unknown> {
    const $ = new PublicPlayerRecord$(Network.create(requestConfig), namespace, cache)
    const resp = await $.deleteRecord_ByUserId_ByKey(key, userId)
    if (resp.error) throw resp.error
    return resp.response.data
  }
   ...
   */
  async function getRecord_ByUserId_ByKey(key: string, userId: string): Promise<PlayerRecordResponse> {
    const $ = new PublicPlayerRecord$(Network.create(requestConfig), namespace, cache)
    const resp = await $.getRecord_ByUserId_ByKey(key, userId)
    if (resp.error) throw resp.error
    return resp.response.data
  }
   ...
   */
  async function createRecord_ByUserId_ByKey(key: string, userId: string, data: PlayerRecordRequest): Promise<PlayerRecordResponse> {
    const $ = new PublicPlayerRecord$(Network.create(requestConfig), namespace, cache)
    const resp = await $.createRecord_ByUserId_ByKey(key, userId, data)
    if (resp.error) throw resp.error
    return resp.response.data
  }
   ...
   */
  async function updateRecord_ByUserId_ByKey(key: string, userId: string, data: PlayerRecordRequest): Promise<PlayerRecordResponse> {
    const $ = new PublicPlayerRecord$(Network.create(requestConfig), namespace, cache)
    const resp = await $.updateRecord_ByUserId_ByKey(key, userId, data)
    if (resp.error) throw resp.error
    return resp.response.data
  }
   ...
   */
  async function getPublic_ByUserId_ByKey(key: string, userId: string): Promise<PlayerRecordResponse> {
    const $ = new PublicPlayerRecord$(Network.create(requestConfig), namespace, cache)
    const resp = await $.getPublic_ByUserId_ByKey(key, userId)
    if (resp.error) throw resp.error
    return resp.response.data
  }
   ...
   */
  async function createPublic_ByUserId_ByKey(key: string, userId: string, data: PlayerRecordRequest): Promise<PlayerRecordResponse> {
    const $ = new PublicPlayerRecord$(Network.create(requestConfig), namespace, cache)
    const resp = await $.createPublic_ByUserId_ByKey(key, userId, data)
    if (resp.error) throw resp.error
    return resp.response.data
  }
   ...
   */
  async function updatePublic_ByUserId_ByKey(key: string, userId: string, data: PlayerRecordRequest): Promise<PlayerRecordResponse> {
    const $ = new PublicPlayerRecord$(Network.create(requestConfig), namespace, cache)
    const resp = await $.updatePublic_ByUserId_ByKey(key, userId, data)
    if (resp.error) throw resp.error
    return resp.response.data
  }
