...
export class AdminRecordAdmin$ {
  ...
  getAdminrecords(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, ListAdminGameRecordKeysResponse, 'ListAdminGameRecordKeysResponse')
  ...
  createAdminrecordBulk(data: BulkGetAdminGameRecordRequest): Promise<IResponse<BulkGetAdminGameRecordResponse>> {
    ...
    return Validate.responseType(() => resultPromise, BulkGetAdminGameRecordResponse, 'BulkGetAdminGameRecordResponse')
  }
  ...
  getAdminrecord_ByKey(key: string): Promise<IResponseWithSync<AdminGameRecordResponse>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, AdminGameRecordResponse, 'AdminGameRecordResponse')
  ...
  createAdminrecord_ByKey(key: string, data: AdminGameRecordRequest): Promise<IResponse<AdminGameRecordResponse>> {
    ...
    return Validate.responseType(() => resultPromise, AdminGameRecordResponse, 'AdminGameRecordResponse')
  }
  ...
  getAdminrecords_ByUserId(
    ...
    const res = () => Validate.responseType(() => resultPromise, ListAdminPlayerRecordKeysResponse, 'ListAdminPlayerRecordKeysResponse')
  ...
  createBulkUser_ByKey(key: string, data: BulkUserIDsRequest): Promise<IResponse<BulkGetAdminPlayerRecordResponse>> {
    ...
    return Validate.responseType(() => resultPromise, BulkGetAdminPlayerRecordResponse, 'BulkGetAdminPlayerRecordResponse')
  }
  ...
  getAdminrecord_ByUserId_ByKey(userId: string, key: string): Promise<IResponseWithSync<AdminPlayerRecordResponse>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, AdminPlayerRecordResponse, 'AdminPlayerRecordResponse')
  ...
  createAdminrecord_ByUserId_ByKey(
    ...
    return Validate.responseType(() => resultPromise, AdminPlayerRecordResponse, 'AdminPlayerRecordResponse')
  }
