...
export class PlayerAdmin$ {
  ...
  getPlayerCcu(): Promise<IResponseWithSync<GetLobbyCcuResponse>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, GetLobbyCcuResponse, 'GetLobbyCcuResponse')
  ...
  createPlayerUserBulkBlocked(data: GetBulkAllPlayerBlockedUsersRequest): Promise<IResponse<GetBulkAllPlayerBlockedUsersResponse>> {
    ...
    return Validate.responseType(() => resultPromise, GetBulkAllPlayerBlockedUsersResponse, 'GetBulkAllPlayerBlockedUsersResponse')
  }
  ...
  getAttributePlayer_ByUserId_ByAttribute(
    ...
    const res = () => Validate.responseType(() => resultPromise, GetPlayerSessionAttributeResponse, 'GetPlayerSessionAttributeResponse')
