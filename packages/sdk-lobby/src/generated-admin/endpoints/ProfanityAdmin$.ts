...
export class ProfanityAdmin$ {
  ...
  getProfanityRule(): Promise<IResponseWithSync<ProfanityRule>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, ProfanityRule, 'ProfanityRule')
  ...
  createProfanityVerify(data: AdminVerifyMessageProfanityRequest): Promise<IResponse<AdminVerifyMessageProfanityResponse>> {
    ...
    return Validate.responseType(() => resultPromise, AdminVerifyMessageProfanityResponse, 'AdminVerifyMessageProfanityResponse')
  }
  ...
  createProfanityFilterDebug(data: DebugProfanityFilterRequest): Promise<IResponse<ProfanityFilterArray>> {
    ...
    return Validate.responseType(() => resultPromise, ProfanityFilterArray, 'ProfanityFilterArray')
  }
