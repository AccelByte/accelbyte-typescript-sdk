...
export class NotificationAdmin$ {
  ...
  getNotificationTopics(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, GetAllNotificationTopicsResponse, 'GetAllNotificationTopicsResponse')
  ...
  getNotificationTemplates(): Promise<IResponseWithSync<NotificationTemplateResponseArray>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, NotificationTemplateResponseArray, 'NotificationTemplateResponseArray')
  ...
  getNotificationTopic_ByTopicName(topicName: string): Promise<IResponseWithSync<NotificationTopicResponseV1>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, NotificationTopicResponseV1, 'NotificationTopicResponseV1')
  ...
  getNotificationTemplate_ByTemplateSlug(
    ...
    const res = () => Validate.responseType(() => resultPromise, GetAllNotificationTemplateSlugResp, 'GetAllNotificationTemplateSlugResp')
  ...
  getLanguageNotification_ByTemplateSlug_ByTemplateLanguage(
    ...
    const res = () => Validate.responseType(() => resultPromise, Localization, 'Localization')
