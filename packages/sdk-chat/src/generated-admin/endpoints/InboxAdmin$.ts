...
export class InboxAdmin$ {
  ...
  getInboxStats(queryParams?: { messageId?: string[] }): Promise<IResponseWithSync<GetInboxStatsResponse>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, GetInboxStatsResponse, 'GetInboxStatsResponse')
  ...
  getInboxMessages(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, GetInboxMessagesResponse, 'GetInboxMessagesResponse')
  ...
  createInboxMessage(data: SaveInboxMessageRequest): Promise<IResponse<SaveInboxMessageResponse>> {
    ...
    return Validate.responseType(() => resultPromise, SaveInboxMessageResponse, 'SaveInboxMessageResponse')
  }
  ...
  getInboxCategories(): Promise<IResponseWithSync<GetInboxCategoriesResponseItemArray>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, GetInboxCategoriesResponseItemArray, 'GetInboxCategoriesResponseItemArray')
  ...
  createInboxCategory(data: AddInboxCategoryRequest): Promise<IResponse<AddInboxCategoryResponse>> {
    ...
    return Validate.responseType(() => resultPromise, AddInboxCategoryResponse, 'AddInboxCategoryResponse')
  }
  ...
  getUsersInbox_ByInbox(
    ...
    const res = () => Validate.responseType(() => resultPromise, GetInboxUsersResponse, 'GetInboxUsersResponse')
  ...
  createUnsendInbox_ByInbox(inbox: string, data: UnsendInboxMessageRequest): Promise<IResponse<UnsendInboxMessageResponse>> {
    ...
    return Validate.responseType(() => resultPromise, UnsendInboxMessageResponse, 'UnsendInboxMessageResponse')
  }
  ...
  createSendInbox_ByMessageId(messageId: string, data: SendInboxMessageRequest): Promise<IResponse<SendInboxMessageResponse>> {
    ...
    return Validate.responseType(() => resultPromise, SendInboxMessageResponse, 'SendInboxMessageResponse')
  }
  ...
  getSchemaJsonInbox_ByCategory(category: string): Promise<IResponseWithSync<JsonSchemaType>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, JsonSchemaType, 'JsonSchemaType')
