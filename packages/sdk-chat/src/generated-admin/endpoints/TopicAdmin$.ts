...
export class TopicAdmin$ {
  ...
  getChats(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, ChatMessageWithPaginationResponse, 'ChatMessageWithPaginationResponse')
  ...
  getTopic(queryParams?: { limit?: number; offset?: number; topicType?: string | null }): Promise<IResponseWithSync<TopicResponseArray>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, TopicResponseArray, 'TopicResponseArray')
  ...
  createTopic(data: CreateTopicParams): Promise<IResponse<CreateTopicResponse>> {
    ...
    return Validate.responseType(() => resultPromise, CreateTopicResponse, 'CreateTopicResponse')
  }
  ...
  getTopics(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, TopicInfoArray, 'TopicInfoArray')
  ...
  getTopicLog(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, TopicLogWithPaginationResponse, 'TopicLogWithPaginationResponse')
  ...
  deleteTopic_ByTopic(topic: string): Promise<IResponse<ActionDeleteTopicResult>> {
    ...
    return Validate.responseType(() => resultPromise, ActionDeleteTopicResult, 'ActionDeleteTopicResult')
  }
  ...
  getTopicChannel(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, ChannelTopicWithPaginationResponse, 'ChannelTopicWithPaginationResponse')
  ...
  createChat_ByTopic(topic: string, data: SendChatParams): Promise<IResponse<ChatMessageResponseArray>> {
    ...
    return Validate.responseType(() => resultPromise, ChatMessageResponseArray, 'ChatMessageResponseArray')
  }
  ...
  getChannel_ByTopic(topic: string): Promise<IResponseWithSync<ChannelTopicResponse>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, ChannelTopicResponse, 'ChannelTopicResponse')
  ...
  getMembers_ByTopic(
    ...
    const res = () => Validate.responseType(() => resultPromise, TopicMemberWithPaginationResponse, 'TopicMemberWithPaginationResponse')
  ...
  getTopicChannelSummary(): Promise<IResponseWithSync<ChannelTopicSummaryResponse>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, ChannelTopicSummaryResponse, 'ChannelTopicSummaryResponse')
  ...
  createBanMember_ByTopic(topic: string, data: BanTopicMemberParam): Promise<IResponse<BanTopicMemberResult>> {
    ...
    return Validate.responseType(() => resultPromise, BanTopicMemberResult, 'BanTopicMemberResult')
  }
  ...
  createUnbanMember_ByTopic(topic: string, data: UnbanTopicMemberParam): Promise<IResponse<UnbanTopicMemberResult>> {
    ...
    return Validate.responseType(() => resultPromise, UnbanTopicMemberResult, 'UnbanTopicMemberResult')
  }
  ...
  deleteUser_ByTopic_ByUserId(topic: string, userId: string): Promise<IResponse<ActionAddUserToTopicResult>> {
    ...
    return Validate.responseType(() => resultPromise, ActionAddUserToTopicResult, 'ActionAddUserToTopicResult')
  }
