...
export class ConfigurationAdmin$ {
  ...
  getConfiguration(queryParams?: { limit?: number; offset?: number }): Promise<IResponseWithSync<ListConfigurationResponseV1>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, ListConfigurationResponseV1, 'ListConfigurationResponseV1')
  ...
  createConfiguration(data: CreateGroupConfigurationRequestV1): Promise<IResponse<CreateGroupConfigurationResponseV1>> {
    ...
    return Validate.responseType(() => resultPromise, CreateGroupConfigurationResponseV1, 'CreateGroupConfigurationResponseV1')
  }
  ...
  getConfiguration_ByConfigurationCode(configurationCode: string): Promise<IResponseWithSync<GetGroupConfigurationResponseV1>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, GetGroupConfigurationResponseV1, 'GetGroupConfigurationResponseV1')
  ...
  patchConfiguration_ByConfigurationCode(
    ...
    return Validate.responseType(() => resultPromise, UpdateGroupConfigurationResponseV1, 'UpdateGroupConfigurationResponseV1')
  }
