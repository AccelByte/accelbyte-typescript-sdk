...
export class LeaderboardConfigurationAdmin$ {
  ...
  getLeaderboards(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, GetAllLeaderboardConfigsResp, 'GetAllLeaderboardConfigsResp')
  ...
  getLeaderboard_ByLeaderboardCode(leaderboardCode: string): Promise<IResponseWithSync<GetLeaderboardConfigResp>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, GetLeaderboardConfigResp, 'GetLeaderboardConfigResp')
  ...
  updateLeaderboard_ByLeaderboardCode(
    ...
    return Validate.responseType(() => resultPromise, GetLeaderboardConfigResp, 'GetLeaderboardConfigResp')
  }
