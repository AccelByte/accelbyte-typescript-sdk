...
export class Policies$ {
   ...
   */
  fetchPolicy_ByNamespace<T = RetrievePolicyPublicResponseArray>(queryParams?: {
   ...
   */
  fetchPolicyCountry_ByCountryCode<T = RetrievePolicyPublicResponseArray>(
    countryCode: string,
    queryParams?: {
      policyType?: 'LEGAL_DOCUMENT_TYPE' | 'MARKETING_PREFERENCE_TYPE'
      tags?: string | null
   ...
   */
  fetchPolicyCountry_ByCountryCode_ByNS<T = RetrievePolicyPublicResponseArray>(
    countryCode: string,
    queryParams?: {
      policyType?: 'LEGAL_DOCUMENT_TYPE' | 'MARKETING_PREFERENCE_TYPE'
      tags?: string | null
