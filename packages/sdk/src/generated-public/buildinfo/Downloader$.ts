...
export class Downloader$ {
   ...
   */
  postNsBuildsByBuildidBlocksUrls<T = BlockDownloadUrls>(buildId: string, data: BlockDownloadUrlsRequest): Promise<IResponse<T>> {
   ...
   */
  fetchNsBulkCheckLatest<T = BuildAvailabilityArray>(queryParams: { appIds: string[] }): Promise<IResponseWithSync<T>> {
   ...
   */
  fetchNsV2UpdategameByAppidByVersionByPlatformid<T = BuildManifest>(
    appId: string,
    version: string,
    platformId: string
   ...
   */
  fetchNsAvailablebuildsByAppid<T = BasicBuildManifestArray>(appId: string): Promise<IResponseWithSync<T>> {
    const params = {} as SDKRequestConfig
   ...
   */
  fetchNsDiffBySourcebuildidByDestinationbuildid<T = DiffStatusReport>(
   ...
   */
  fetchNsVersionHistory<T = VersionChain>(queryParams: {
    appId: string | null
   ...
   */
  fetchNsV2UpdategameByAppidByPlatformid<T = BuildManifest>(appId: string, platformId: string): Promise<IResponseWithSync<T>> {
    const params = {} as SDKRequestConfig
   ...
   */
  fetchNsV2UpdategameBuildsByBuildid<T = BuildManifest>(buildId: string): Promise<IResponseWithSync<T>> {
    const params = {} as SDKRequestConfig
