...
export class Downloader$ {
   ...
   */
  fetchAvailablebuild_ByAppId<T = BasicBuildManifestArray>(appId: string): Promise<IResponseWithSync<T>> {
   ...
   */
  createBlockUrl_ByBuildId<T = BlockDownloadUrls>(buildId: string, data: BlockDownloadUrlsRequest): Promise<IResponse<T>> {
    const params = {} as SDKRequestConfig
   ...
   */
  fetchUpdategameBuild_ByBuildId<T = BuildManifest>(buildId: string): Promise<IResponseWithSync<T>> {
    const params = {} as SDKRequestConfig
   ...
   */
  fetchUpdategame_ByAppId_ByPlatformId<T = BuildManifest>(appId: string, platformId: string): Promise<IResponseWithSync<T>> {
    const params = {} as SDKRequestConfig
   ...
   */
  fetchDiff_BySourceBuildId_ByDestinationBuildId<T = DiffStatusReport>(
   ...
   */
  fetchVersion_ByAppId_ByVersion_ByPlatformId<T = BuildManifest>(
    appId: string,
    version: string,
    platformId: string
  ): Promise<IResponseWithSync<T>> {
