...
// TODO: maybe we can use something like tsup instead: https://github.com/egoist/tsup.
    ...
    generateBundle(_opts, bundle, _isWrite) {
      ...
      for (let i = 0; i < fileNames.length; i += 1) {
        ...
        if (fileName.endsWith('.d.ts')) {
          // Example `fileName`: packages/sdk/src/generated/platform/definitions/WalletPagingSlicedResult.d.ts.
