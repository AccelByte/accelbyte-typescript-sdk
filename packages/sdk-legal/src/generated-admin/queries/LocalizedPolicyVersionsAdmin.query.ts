...
export enum Key_LocalizedPolicyVersionsAdmin {
  LocalizedPolicyVersion_ByLocalizedPolicyVersionId = 'LocalizedPolicyVersionsAdmin.LocalizedPolicyVersion_ByLocalizedPolicyVersionId',
  LocalizedPolicyVersionVersion_ByPolicyVersionId = 'LocalizedPolicyVersionsAdmin.LocalizedPolicyVersionVersion_ByPolicyVersionId',
  Default_ByLocalizedPolicyVersionId = 'LocalizedPolicyVersionsAdmin.Default_ByLocalizedPolicyVersionId',
  Attachment_ByLocalizedPolicyVersionId = 'LocalizedPolicyVersionsAdmin.Attachment_ByLocalizedPolicyVersionId'
}
...
export const useAdmLocalizedPolicyVersion_ByLocalizedPolicyVersionId = (
  ...
  const queryFn = (sdk: AccelbyteSDK, input: Parameters<typeof useAdmLocalizedPolicyVersion_ByLocalizedPolicyVersionId>[1]) => async () => {
    const data = await LocalizedPolicyVersionsAdminApi(sdk, {
