...
export function PolicyVersionsAdminApi(sdk: AccelbyteSDK, args?: ApiArgs) {
  ...
  async function getVersions_ByPolicyId(
    ...
    const $ = new PolicyVersionsAdmin$(Network.create(requestConfig), namespace, cache, isValidationEnabled)
