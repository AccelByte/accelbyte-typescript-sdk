...
export class UserActionAdmin$ {
  ...
  getActions(): Promise<IResponseWithSync<ActionArray>> {
    ...
    const res = () =>
      this.isValidationEnabled
        ? Validate.responseType(() => resultPromise, ActionArray, 'ActionArray')
  ...
  getActionsBanned(queryParams: { userIds: string[] }): Promise<IResponseWithSync<ADtoObjectForEqu8UserBanStatusArray>> {
    ...
    const res = () =>
      this.isValidationEnabled
        ? Validate.responseType(() => resultPromise, ADtoObjectForEqu8UserBanStatusArray, 'ADtoObjectForEqu8UserBanStatusArray')
        : Validate.unsafeResponse(() => resultPromise)
  ...
  getActionsStatus(queryParams: { userId: string | null }): Promise<IResponseWithSync<ADtoObjectForEqu8UserStatus>> {
    ...
    const res = () =>
      this.isValidationEnabled
        ? Validate.responseType(() => resultPromise, ADtoObjectForEqu8UserStatus, 'ADtoObjectForEqu8UserStatus')
        : Validate.unsafeResponse(() => resultPromise)
