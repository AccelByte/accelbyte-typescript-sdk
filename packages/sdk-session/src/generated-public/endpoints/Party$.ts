...
export class Party$ {
  ...
  createParty(data: CreatePartyRequest): Promise<IResponse<PartySessionResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.isZodEnabled, () => resultPromise, PartySessionResponse, 'PartySessionResponse')
  }
  ...
  createInvite_ByPartyId(partyId: string, data: SessionInviteRequest): Promise<IResponse<SessionInviteResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.isZodEnabled, () => resultPromise, SessionInviteResponse, 'SessionInviteResponse')
  }
  ...
  deleteKick_ByPartyId_ByUserId(partyId: string, userId: string): Promise<IResponse<KickResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.isZodEnabled, () => resultPromise, KickResponse, 'KickResponse')
  }
}
