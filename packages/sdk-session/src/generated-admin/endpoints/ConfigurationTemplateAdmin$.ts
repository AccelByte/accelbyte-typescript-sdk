...
export class ConfigurationTemplateAdmin$ {
  ...
  createConfiguration(data: CreateConfigurationTemplateRequest): Promise<IResponse<ConfigurationTemplateResponse>> {
    ...
    return Validate.responseType(() => resultPromise, ConfigurationTemplateResponse, 'ConfigurationTemplateResponse')
  }
  ...
  getConfigurations(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, ConfigurationTemplatesResponse, 'ConfigurationTemplatesResponse')
  ...
  getAlertsConfiguration(): Promise<IResponseWithSync<ConfigAlertResponse>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, ConfigAlertResponse, 'ConfigAlertResponse')
  ...
  createAlertsConfiguration(data: ConfigAlertRequestCreate): Promise<IResponse<ConfigAlertResponse>> {
    ...
    return Validate.responseType(() => resultPromise, ConfigAlertResponse, 'ConfigAlertResponse')
  }
  ...
  getConfiguration_ByName(name: string): Promise<IResponseWithSync<ConfigurationTemplateResponse>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, ConfigurationTemplateResponse, 'ConfigurationTemplateResponse')
