...
export class RecentPlayerAdmin$ {
   ...
   */
  getRecentPlayer(queryParams?: { limit?: number; userId?: string | null }): Promise<IResponse<RecentPlayerQueryResponse>> {
   ...
   */
  getRecentTeamPlayer(queryParams?: { limit?: number; userId?: string | null }): Promise<IResponse<RecentPlayerQueryResponse>> {
    const params = { limit: 20, ...queryParams } as SDKRequestConfig
