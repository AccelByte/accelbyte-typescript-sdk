...
export class CatalogChangesAdmin$ {
  ...
  getCatalogChangesByCriteria_ByStoreId(
    ...
    const res = () => Validate.responseType(() => resultPromise, CatalogChangePagingResult, 'CatalogChangePagingResult')
  ...
  getCatalogChangesStatistics_ByStoreId(
    ...
    const res = () => Validate.responseType(() => resultPromise, CatalogChangeStatistics, 'CatalogChangeStatistics')
