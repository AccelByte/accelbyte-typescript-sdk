...
export class EntitlementAdmin$ {
  ...
  createEntitlementGrant(data: BulkEntitlementGrantRequest): Promise<IResponse<BulkEntitlementGrantResult>> {
    ...
    return Validate.responseType(() => resultPromise, BulkEntitlementGrantResult, 'BulkEntitlementGrantResult')
  }
  ...
  createEntitlementRevoke(data: string[]): Promise<IResponse<BulkEntitlementRevokeResult>> {
    ...
    return Validate.responseType(() => resultPromise, BulkEntitlementRevokeResult, 'BulkEntitlementRevokeResult')
  }
  ...
  getEntitlementsConfigInfo(queryParams?: { withoutCache?: boolean | null }): Promise<IResponseWithSync<EntitlementConfigInfo>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, EntitlementConfigInfo, 'EntitlementConfigInfo')
  ...
  createEntitlement_ByUserId(userId: string, data: EntitlementGrant[]): Promise<IResponse<StackableEntitlementInfoArray>> {
    ...
    return Validate.responseType(() => resultPromise, StackableEntitlementInfoArray, 'StackableEntitlementInfoArray')
  }
  ...
  getEntitlementsByItemIds_ByUserId(
    ...
    const res = () => Validate.responseType(() => resultPromise, EntitlementInfoArray, 'EntitlementInfoArray')
  ...
  getEntitlementConfig_ByPlatform(platform: string): Promise<IResponseWithSync<EntitlementPlatformConfigInfo>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, EntitlementPlatformConfigInfo, 'EntitlementPlatformConfigInfo')
  ...
  updateEntitlementConfig_ByPlatform(
    ...
    return Validate.responseType(() => resultPromise, EntitlementPlatformConfigInfo, 'EntitlementPlatformConfigInfo')
  }
  ...
  updateEntitlement_ByUserId_ByEntitlementId(
    ...
    return Validate.responseType(() => resultPromise, EntitlementInfo, 'EntitlementInfo')
  }
  ...
  updateEntitlementConfigEntitlementOriginEnable(): Promise<IResponse<EntitlementConfigInfo>> {
    ...
    return Validate.responseType(() => resultPromise, EntitlementConfigInfo, 'EntitlementConfigInfo')
  }
  ...
  getHistory_ByUserId_ByEntitlementId(userId: string, entitlementId: string): Promise<IResponseWithSync<EntitlementHistoryInfoArray>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, EntitlementHistoryInfoArray, 'EntitlementHistoryInfoArray')
  ...
  createRevokeByUseCount_ByUserId_ByEntitlementId(
    ...
    return Validate.responseType(() => resultPromise, EntitlementIfc, 'EntitlementIfc')
  }
  ...
  getRevokeByUseCountPreCheck_ByUserId_ByEntitlementId(
    ...
    const res = () => Validate.responseType(() => resultPromise, EntitlementPrechekResult, 'EntitlementPrechekResult')
