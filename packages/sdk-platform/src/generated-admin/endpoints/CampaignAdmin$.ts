...
export class CampaignAdmin$ {
  ...
  getCampaigns(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, CampaignPagingSlicedResult, 'CampaignPagingSlicedResult')
  ...
  createCampaign(data: CampaignCreate): Promise<IResponse<CampaignInfo>> {
    ...
    return Validate.responseType(() => resultPromise, CampaignInfo, 'CampaignInfo')
  }
  ...
  getCode_ByCode(code: string, queryParams?: { redeemable?: boolean | null }): Promise<IResponseWithSync<CodeInfo>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, CodeInfo, 'CodeInfo')
  ...
  updateEnable_ByCode(code: string): Promise<IResponse<CodeInfo>> {
    ...
    return Validate.responseType(() => resultPromise, CodeInfo, 'CodeInfo')
  }
  ...
  getCampaign_ByCampaignId(campaignId: string): Promise<IResponseWithSync<CampaignInfo>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, CampaignInfo, 'CampaignInfo')
  ...
  createRedemption_ByUserId(userId: string, data: RedeemRequest): Promise<IResponse<RedeemResult>> {
    ...
    return Validate.responseType(() => resultPromise, RedeemResult, 'RedeemResult')
  }
  ...
  getCodeCampaign_ByCampaignId(
    ...
    const res = () => Validate.responseType(() => resultPromise, CodeInfoPagingSlicedResult, 'CodeInfoPagingSlicedResult')
  ...
  createCodeCampaign_ByCampaignId(campaignId: string, data: CodeCreate): Promise<IResponse<CodeCreateResult>> {
    ...
    return Validate.responseType(() => resultPromise, CodeCreateResult, 'CodeCreateResult')
  }
  ...
  getDynamic_ByCampaignId(campaignId: string): Promise<IResponseWithSync<CampaignDynamicInfo>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, CampaignDynamicInfo, 'CampaignDynamicInfo')
  ...
  getHistoryCodes_ByCampaignId(
    ...
    const res = () => Validate.responseType(() => resultPromise, RedeemHistoryPagingSlicedResult, 'RedeemHistoryPagingSlicedResult')
