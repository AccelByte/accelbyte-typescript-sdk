...
export class PaymentAdmin$ {
  ...
  getPaymentOrders(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, PaymentOrderPagingSlicedResult, 'PaymentOrderPagingSlicedResult')
  ...
  createPaymentOrder_ByUserId(userId: string, data: PaymentOrderCreate): Promise<IResponse<PaymentOrderInfo>> {
    ...
    return Validate.responseType(() => resultPromise, PaymentOrderInfo, 'PaymentOrderInfo')
  }
  ...
  getPaymentOrder_ByPaymentOrderNo(paymentOrderNo: string): Promise<IResponseWithSync<PaymentOrderInfo>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, PaymentOrderInfo, 'PaymentOrderInfo')
  ...
  getStatusPayment_ByPaymentOrderNo(paymentOrderNo: string): Promise<IResponseWithSync<PaymentOrderChargeStatus>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, PaymentOrderChargeStatus, 'PaymentOrderChargeStatus')
  ...
  updateSimulateNotificationPayment_ByPaymentOrderNo(
    ...
    return Validate.responseType(() => resultPromise, NotificationProcessResult, 'NotificationProcessResult')
  }
