...
export class ClawbackAdmin$ {
  ...
  getIapClawbackHistories(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, IapClawbackPagingSlicedResult, 'IapClawbackPagingSlicedResult')
   ...
   */
  createIapClawbackPlaystationMock(data: StreamEvent): Promise<IResponse<unknown>> {
