...
export class DlcAdmin$ {
  ...
  getDlcConfigItem(): Promise<IResponseWithSync<DlcItemConfigInfo>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, DlcItemConfigInfo, 'DlcItemConfigInfo')
  ...
  updateDlcConfigItem(data: DlcItemConfigUpdate): Promise<IResponse<DlcItemConfigInfo>> {
    ...
    return Validate.responseType(() => resultPromise, DlcItemConfigInfo, 'DlcItemConfigInfo')
  }
  ...
  getDlc_ByUserId(
    ...
    const res = () => Validate.responseType(() => resultPromise, UserDlc, 'UserDlc')
  ...
  getDlcConfigPlatformMap(): Promise<IResponseWithSync<PlatformDlcConfigInfo>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, PlatformDlcConfigInfo, 'PlatformDlcConfigInfo')
  ...
  updateDlcConfigPlatformMap(data: PlatformDlcConfigUpdate): Promise<IResponse<PlatformDlcConfigInfo>> {
    ...
    return Validate.responseType(() => resultPromise, PlatformDlcConfigInfo, 'PlatformDlcConfigInfo')
  }
  ...
  getDlcRecords_ByUserId(
    ...
    const res = () => Validate.responseType(() => resultPromise, UserDlcRecordArray, 'UserDlcRecordArray')
