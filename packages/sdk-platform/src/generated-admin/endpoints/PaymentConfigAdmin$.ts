...
export class PaymentConfigAdmin$ {
  ...
  getPaymentConfigTax(): Promise<IResponseWithSync<PaymentTaxConfigInfo>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, PaymentTaxConfigInfo, 'PaymentTaxConfigInfo')
  ...
  updatePaymentConfigTax(data: PaymentTaxConfigEdit): Promise<IResponse<PaymentTaxConfigInfo>> {
    ...
    return Validate.responseType(() => resultPromise, PaymentTaxConfigInfo, 'PaymentTaxConfigInfo')
  }
  ...
  createPaymentConfigProvider(data: PaymentProviderConfigEdit): Promise<IResponse<PaymentProviderConfigInfo>> {
    ...
    return Validate.responseType(() => resultPromise, PaymentProviderConfigInfo, 'PaymentProviderConfigInfo')
  }
  ...
  getPaymentConfigMerchant_ById(id: string): Promise<IResponseWithSync<PaymentMerchantConfigInfo>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, PaymentMerchantConfigInfo, 'PaymentMerchantConfigInfo')
  ...
  getPaymentConfigProviderMatched(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, PaymentProviderConfigInfo, 'PaymentProviderConfigInfo')
  ...
  updateAdyenconfigPayment_ById(
    ...
    return Validate.responseType(() => resultPromise, PaymentMerchantConfigInfo, 'PaymentMerchantConfigInfo')
  }
