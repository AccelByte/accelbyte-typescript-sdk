...
export class RevocationAdmin$ {
  ...
  getRevocationConfig(): Promise<IResponseWithSync<RevocationConfigInfo>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, RevocationConfigInfo, 'RevocationConfigInfo')
  ...
  updateRevocationConfig(data: RevocationConfigUpdate): Promise<IResponse<RevocationConfigInfo>> {
    ...
    return Validate.responseType(() => resultPromise, RevocationConfigInfo, 'RevocationConfigInfo')
  }
  ...
  getRevocationHistory(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, RevocationHistoryPagingSlicedResult, 'RevocationHistoryPagingSlicedResult')
  ...
  updateRevocation_ByUserId(userId: string, data: RevocationRequest): Promise<IResponse<RevocationResult>> {
    ...
    return Validate.responseType(() => resultPromise, RevocationResult, 'RevocationResult')
  }
}
