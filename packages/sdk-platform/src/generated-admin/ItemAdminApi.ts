...
export function ItemAdminApi(sdk: AccelbyteSDK, args?: ApiArgs) {
  ...
  async function getItemsConfigs(): Promise<ItemTypeConfigInfoArray> {
    const $ = new ItemAdmin$(Network.create(requestConfig), namespace, cache, isValidationEnabled)
  ...
  /**
   * &lt;b&gt;[Not Supported Yet In Starter]&lt;/b&gt;This API is used to create an item type config.&lt;p&gt;&lt;li&gt;&lt;i&gt;Required permission&lt;/i&gt;: resource=&#34;ADMIN:ITEM:CONFIG&#34;, action=1 (CREATE)&lt;/li&gt;&lt;li&gt;&lt;i&gt;Returns&lt;/i&gt;: item type config data&lt;/li&gt;&lt;/ul&gt;
   */
  ...
  /**
   * &lt;b&gt;[Not Supported Yet In Starter]&lt;/b&gt;This API is used to delete an item type config permanently.Other detail info: &lt;ul&gt;&lt;li&gt;&lt;i&gt;Required permission&lt;/i&gt;: resource=&#34;ADMIN:ITEM:CONFIG&#34;, action=8 (DELETE)&lt;/li&gt;&lt;/ul&gt;
   */
  ...
  /**
   * &lt;b&gt;[Not Supported Yet In Starter]&lt;/b&gt;This API is used to update an item type config.&lt;p&gt;&lt;li&gt;&lt;i&gt;Required permission&lt;/i&gt;: resource=&#34;ADMIN:ITEM:CONFIG&#34;, action=4 (UPDATE)&lt;/li&gt;&lt;li&gt;&lt;i&gt;Returns&lt;/i&gt;: item type config data&lt;/li&gt;&lt;/ul&gt;
   */
