...
export const SectionItemInfo = z.object({
  ...
  sectionExclusiveDiscountPercentage: z.number().int().nullish(),
...
export interface SectionItemInfo extends z.TypeOf<typeof SectionItemInfo> {}
