...
export class UploaderV1Admin$ {
  ...
  getBuildsdeletionByAppId(queryParams: {
    ...
    const res = () => Validate.responseType(() => resultPromise, BuildDeletionDataArray, 'BuildDeletionDataArray')
  ...
  getRetrievechunkbyhash_ByHash(hash: string): Promise<IResponseWithSync<BlockData>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, BlockData, 'BlockData')
