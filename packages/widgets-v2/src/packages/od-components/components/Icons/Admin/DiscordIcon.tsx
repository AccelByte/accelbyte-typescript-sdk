...
export const DiscordIcon = ({ className }: { className?: string }) => (
  <i className={className}>
    <svg
      ...
      <rect width={48} height={48} rx={4} fill="#5865F2" />
      <rect x={8} y={8} width={32} height={32} fill="url(#patternDiscord)" />
      <defs>
        <pattern id="patternDiscord" patternContentUnits="objectBoundingBox" width={1} height={1}>
          <use xlinkHref="#image0_3003_98485" transform="translate(0.00465116) scale(0.00465116 0.00416667)" />
        </pattern>
        <image
          id="image0_3003_98485"
          width={213}
          height={240}
