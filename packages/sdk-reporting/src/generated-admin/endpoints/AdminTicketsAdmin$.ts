...
export class AdminTicketsAdmin$ {
  ...
  getTickets(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, TicketListResponse, 'TicketListResponse')
  ...
  getTicketsStatistic(queryParams: {
    ...
    const res = () => Validate.responseType(() => resultPromise, TicketStatisticResponse, 'TicketStatisticResponse')
  ...
  getTicket_ByTicketId(ticketId: string): Promise<IResponseWithSync<TicketResponse>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, TicketResponse, 'TicketResponse')
  ...
  createResolution_ByTicketId(ticketId: string, data: UpdateTicketResolutionsRequest): Promise<IResponse<TicketResponse>> {
    ...
    return Validate.responseType(() => resultPromise, TicketResponse, 'TicketResponse')
  }
}
