...
export class AdminModerationRuleAdmin$ {
  ...
  getRules(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, ModerationRulesList, 'ModerationRulesList')
  ...
  updateRule_ByRuleId(ruleId: string, data: ModerationRuleRequest): Promise<IResponse<ModerationRuleResponse>> {
    ...
    return Validate.responseType(() => resultPromise, ModerationRuleResponse, 'ModerationRuleResponse')
  }
  ...
  getRule_ByRuleId(ruleId: string): Promise<IResponseWithSync<ModerationRuleResponse>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, ModerationRuleResponse, 'ModerationRuleResponse')
