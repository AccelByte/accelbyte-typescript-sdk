...
export class AdminReasonsAdmin$ {
  ...
  getReasons(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, AdminReasonListResponse, 'AdminReasonListResponse')
  ...
  createReason(data: CreateReasonRequest): Promise<IResponse<AdminReasonResponse>> {
    ...
    return Validate.responseType(() => resultPromise, AdminReasonResponse, 'AdminReasonResponse')
  }
  ...
  getReasonsAll(): Promise<IResponseWithSync<AdminAllReasonsResponse>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, AdminAllReasonsResponse, 'AdminAllReasonsResponse')
  ...
  createReasonGroup(data: CreateReasonGroupRequest): Promise<IResponse<ReasonGroupResponse>> {
    ...
    return Validate.responseType(() => resultPromise, ReasonGroupResponse, 'ReasonGroupResponse')
  }
  ...
  getReasonsUnused(queryParams: {
    ...
    const res = () => Validate.responseType(() => resultPromise, UnusedReasonListResponse, 'UnusedReasonListResponse')
  ...
  getReason_ByReasonId(reasonId: string): Promise<IResponseWithSync<AdminReasonResponse>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, AdminReasonResponse, 'AdminReasonResponse')
  ...
  getReasonGroup_ByGroupId(groupId: string): Promise<IResponseWithSync<ReasonGroupResponse>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, ReasonGroupResponse, 'ReasonGroupResponse')
