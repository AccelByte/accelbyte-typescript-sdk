...
export class AchievementsAdmin$ {
  ...
  getAchievements(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, PaginatedAchievementResponse, 'PaginatedAchievementResponse')
  ...
  createAchievement(data: AchievementRequest): Promise<IResponse<AchievementResponse>> {
    ...
    return Validate.responseType(() => resultPromise, AchievementResponse, 'AchievementResponse')
  }
  ...
  getAchievement_ByAchievementCode(achievementCode: string): Promise<IResponseWithSync<AchievementResponse>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, AchievementResponse, 'AchievementResponse')
