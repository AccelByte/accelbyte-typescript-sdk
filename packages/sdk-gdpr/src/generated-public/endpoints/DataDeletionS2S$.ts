...
export class DataDeletionS2S$ {
   ...
   */
  getS2SDeletionsFinished(queryParams: { end: string | null; start: string | null }): Promise<IResponse<ListFinishedDataDeletion>> {
   ...
   */
  createDeletionS2_ByUserId(userId: string): Promise<IResponse<S2SRequestDeleteResponse>> {
