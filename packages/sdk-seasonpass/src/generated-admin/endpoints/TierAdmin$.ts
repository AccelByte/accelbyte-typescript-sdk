...
export class TierAdmin$ {
  ...
  getTiers_BySeasonId(
    ...
    const res = () => Validate.responseType(() => resultPromise, TierPagingSlicedResult, 'TierPagingSlicedResult')
  ...
  createTier_BySeasonId(seasonId: string, data: TierCreate): Promise<IResponse<TierArray>> {
    ...
    return Validate.responseType(() => resultPromise, TierArray, 'TierArray')
  }
  ...
  updateTier_BySeasonId_ById(seasonId: string, id: string, data: TierInput): Promise<IResponse<Tier>> {
    ...
    return Validate.responseType(() => resultPromise, Tier, 'Tier')
  }
