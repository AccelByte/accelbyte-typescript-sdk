...
export class StatConfigurationAdmin$ {
  ...
  getStats(queryParams?: {
    ...
    const res = () => Validate.responseType(() => resultPromise, StatPagingSlicedResult, 'StatPagingSlicedResult')
  ...
  getStat_ByStatCode(statCode: string): Promise<IResponseWithSync<StatInfo>> {
    ...
    const res = () => Validate.responseType(() => resultPromise, StatInfo, 'StatInfo')
