...
export class Users$ {
  ...
  getUsersMe_v3(queryParams?: { includeAllPlatforms?: boolean | null }): Promise<Response<UserResponseV3>> {
    ...
    const url = '/iam/iam/v3/public/users/me'
   ...
   */
  createUserForgot_v3(data: ForgotPasswordWithoutNamespaceRequestV3): Promise<Response<ForgotPasswordResponseV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/users/forgot'
   ...
   */
  getUsersUserinfo_v3(): Promise<Response<PublicOpenIdUserInfoResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/users/userinfo'
    const resultPromise = this.axiosInstance.get(url, { params })

    return Validate.validateOrReturnResponse(
      this.useSchemaValidation,
      () => resultPromise,
      PublicOpenIdUserInfoResponse,
      'PublicOpenIdUserInfoResponse'
    )
  }
  /**
  ...
  createUser(data: UserCreateRequest): Promise<Response<UserCreateResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  getUsersMeProfileStatus_v3(): Promise<Response<UserProfileUpdateAllowStatus>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/users/me/profileStatus'
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getUsersAdmin(queryParams?: {
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/admin'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getUsersVerifyLinkVerify_v3(queryParams?: { code?: string | null }): Promise<Response<unknown>> {
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/public/users/verify_link/verify'
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getUsersSearch(queryParams?: { query?: string | null }): Promise<Response<SearchUsersResponse>> {
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/search'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
   ...
   */
  getUsersMeLinkRedirection_v3(queryParams: { oneTimeLinkCode: string | null }): Promise<Response<OneTimeCodeLinkRedirectionResponse>> {
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/public/users/me/link/redirection'
    const resultPromise = this.axiosInstance.get(url, { params })

    return Validate.validateOrReturnResponse(
      this.useSchemaValidation,
      () => resultPromise,
      OneTimeCodeLinkRedirectionResponse,
      'OneTimeCodeLinkRedirectionResponse'
    )
  }
  /**
  ...
  deleteUser_ByUserId(userId: string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}'.replace('{namespace}', this.namespace).replace('{userId}', userId)
  ...
  getUsersByLoginId(queryParams?: { loginId?: string | null }): Promise<Response<PublicUserResponse>> {
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/byLoginId'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  createUser_v2(data: UserCreateRequest): Promise<Response<UserCreateResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v2/public/namespaces/{namespace}/users'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  getUsers_v3(queryParams?: {
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  createUserMeVerifyLinkRequest_v3(data: SendVerificationLinkRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/users/me/verify_link/request'
    const resultPromise = this.axiosInstance.post(url, data, { params })
   ...
   */
  createUserMeCodeRequestForward_v3(data: SendVerificationCodeRequestV3): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/users/me/code/request/forward'
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  createBan_ByUserId(userId: string, data: BanCreateRequest): Promise<Response<UserBanResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/ban'.replace('{namespace}', this.namespace).replace('{userId}', userId)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  patchUserMe_v3(data: PublicUserUpdateRequestV3): Promise<Response<UserResponseV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/me'.replace('{namespace}', this.namespace)
  ...
  getUsersMeHeadlessLinkConflict_v3(queryParams: {
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/public/users/me/headless/link/conflict'
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getBans_ByUserId(userId: string): Promise<Response<UserBanResponseArray>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/bans'.replace('{namespace}', this.namespace).replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  createUserResetPassword(data: ResetPasswordRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/resetPassword'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  updateRole_ByUserId(userId: string, data: string[]): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/roles'.replace('{namespace}', this.namespace).replace('{userId}', userId)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  createUserForgotPassword(data: SendVerificationCodeRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/forgotPassword'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  getUsersListByLoginIds(queryParams?: { loginIds?: string | null }): Promise<Response<PublicUsersResponse>> {
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/listByLoginIds'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  updateEnable_ByUserId(userId: string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/enable'.replace('{namespace}', this.namespace).replace('{userId}', userId)
  ...
  createUserReset_v3(data: ResetPasswordRequestV3): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/reset'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  updateDisable_ByUserId(userId: string, data: DisableUserRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/disable'.replace('{namespace}', this.namespace).replace('{userId}', userId)
    const resultPromise = this.axiosInstance.put(url, data, { params })
  ...
  getUsersByPlatformUserId(queryParams: {
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/byPlatformUserID'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
   ...
   */
  createUserForgot_ByNS_v3(data: ForgotPasswordRequestV3): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/forgot'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  updatePassword_ByUserId(userId: string, data: UserPasswordUpdateRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/password'.replace('{namespace}', this.namespace).replace('{userId}', userId)
    const resultPromise = this.axiosInstance.put(url, data, { params })
  ...
  postCrosslink_ByUserId(userId: string, data: { linkingToken: string | null; platformId?: string | null }): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/crosslink'
  ...
  getPlatforms_ByUserId(userId: string): Promise<Response<UserLinkedPlatformArray>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/platforms'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getPublisher_ByUserId(userId: string): Promise<Response<GetPublisherUserResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/publisher'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getUser_ByUserId_v2(userId: string): Promise<Response<UserResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v2/public/namespaces/{namespace}/users/{userId}'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getUser_ByUserId_v3(userId: string): Promise<Response<PublicUserResponseV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/{userId}'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  createUserMeHeadlesLinkWithProgression_v3(data: LinkHeadlessAccountRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/users/me/headless/linkWithProgression'
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  createUserPlatform_v3(data: UsersPlatformInfosRequestV3): Promise<Response<UsersPlatformInfosResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/platforms'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  deleteInformation_ByUserId(userId: string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/information'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.delete(url, { params })
  ...
  updatePermission_ByUserId(userId: string, data: Permissions): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/permissions'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  createUserBulkBasic_v3(data: UserIDsRequest): Promise<Response<ListBulkUserResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/bulk/basic'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  updateVerification_ByUserId(userId: string, data: UserVerificationRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/verification'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  createUserCodeVerify_v3(data: VerifyRegistrationCode): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/code/verify'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  updateUserMePassword_v3(data: UserPasswordUpdateV3Request): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/me/password'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.put(url, data, { params })
  ...
  getUsersAvailability_v3(queryParams: { field: string | null; query: string | null }): Promise<Response<unknown>> {
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/availability'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  createUserCodeRequest_v3(data: SendRegisterVerificationCodeRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/code/request'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  deleteRole_ByUserId_ByRoleId(userId: string, roleId: string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/roles/{roleId}'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
  ...
  getBans_ByUserId_v2(userId: string, queryParams?: { activeOnly?: boolean | null }): Promise<Response<UserBanResponseArray>> {
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v2/public/namespaces/{namespace}/users/{userId}/bans'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  createUserResetPassword_v2(data: ResetPasswordRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v2/public/namespaces/{namespace}/users/resetPassword'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  getBans_ByUserId_v3(
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/{userId}/bans'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  createUserForgotPassword_v2(data: SendVerificationCodeRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v2/public/namespaces/{namespace}/users/forgotPassword'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  createUserMeCodeVerify_v3(data: UserVerificationRequestV3): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/me/code/verify'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  getLoginsHistories_ByUserId(
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/logins/histories'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  updateVerificationcode_ByUserId(userId: string, data: SendVerificationCodeRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/verificationcode'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  createUserMeCodeRequest_v3(data: SendVerificationCodeRequestV3): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/me/code/request'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  createUserInputValidation_v3(data: UserInputValidationRequest): Promise<Response<UserInputValidationResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/input/validation'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  updatePassword_ByUserId_v2(userId: string, data: UserPasswordUpdateRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v2/public/namespaces/{namespace}/users/{userId}/password'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.put(url, data, { params })
  ...
  postValidate_ByUserId_v3(userId: string, data: { password: string | null }): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/{userId}/validate'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
  ...
  updateEnable_ByUserId_ByBanId(userId: string, banId: string): Promise<Response<UserBanResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/bans/{banId}/enable'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
      .replace('{banId}', banId)
    const resultPromise = this.axiosInstance.put(url, null, { params })
  ...
  getPlatforms_ByUserId_v3(
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/{userId}/platforms'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getPublisher_ByUserId_v3(userId: string): Promise<Response<GetPublisherUserResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/{userId}/publisher'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  createUserMeHeadlesVerify_v3(
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/me/headless/verify'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  updateDisable_ByUserId_ByBanId(userId: string, banId: string): Promise<Response<UserBanResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/bans/{banId}/disable'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
      .replace('{banId}', banId)
    const resultPromise = this.axiosInstance.put(url, null, { params })
  ...
  getInformation_ByUserId_v3(userId: string): Promise<Response<UserInformationV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/{userId}/information'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  updateUpgradeHeadlessAccount_ByUserId(userId: string, data: UpgradeHeadlessAccountRequest): Promise<Response<UserResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/upgradeHeadlessAccount'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  getUserInvite_ByInvitationId_v3(invitationId: string): Promise<Response<UserInvitationV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/invite/{invitationId}'
      .replace('{namespace}', this.namespace)
  ...
  createUser_ByPlatformId_v3(
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/platforms/{platformId}/users'
      .replace('{namespace}', this.namespace)
  ...
  createPlatformLink_ByUserId_v3(userId: string, data: LinkPlatformAccountRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/{userId}/platforms/link'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  createUserMeHeadlesCodeVerify_v3(data: UpgradeHeadlessAccountWithVerificationCodeRequestV3): Promise<Response<UserResponseV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/me/headless/code/verify'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  getLoginsHistories_ByUserId_v3(
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/{userId}/logins/histories'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  deleteUserMePlatform_ByPlatformId_v3(platformId: string, data: UnlinkUserPlatformRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/me/platforms/{platformId}'
      .replace('{namespace}', this.namespace)
      .replace('{platformId}', platformId)
  ...
  postLink_ByUserId_ByPlatformId(userId: string, platformId: string, data: { ticket: string | null }): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/platforms/{platformId}/link'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
      .replace('{platformId}', platformId)
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
  ...
  getPlatformsJustice_ByUserId_v2(userId: string): Promise<Response<GetUserMappingArray>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v2/public/namespaces/{namespace}/users/{userId}/platforms/justice'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getDistinctPlatforms_ByUserId_v3(userId: string): Promise<Response<DistinctPlatformResponseV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/{userId}/distinctPlatforms'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getPlatformsJustice_ByUserId_v3(userId: string): Promise<Response<GetUserMappingV3Array>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/{userId}/platforms/justice'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getAsyncStatus_ByRequestId_v3(requestId: string): Promise<Response<LinkRequest>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/requests/{requestId}/async/status'
      .replace('{namespace}', this.namespace)
  ...
  postUnlink_ByUserId_ByPlatformId(
    ...
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/platforms/{platformId}/unlink'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
      .replace('{platformId}', platformId)
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
  ...
  deleteAllMeUser_ByPlatformId_v3(platformId: string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/me/platforms/{platformId}/all'
      .replace('{namespace}', this.namespace)
      .replace('{platformId}', platformId)
    const resultPromise = this.axiosInstance.delete(url, { params })
  ...
  deletePermission_ByUserId_ByResource_ByAction(userId: string, resource: string, action: number): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/permissions/{resource}/{action}'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
  ...
  postForceMeUser_ByPlatformId_v3(platformId: string, data: { ticket: string | null }): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/me/platforms/{platformId}/force'
      .replace('{namespace}', this.namespace)
      .replace('{platformId}', platformId)
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
  ...
  getAgerestrictions_ByCountryCode_v2(countryCode: string): Promise<Response<Country>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v2/public/namespaces/{namespace}/countries/{countryCode}/agerestrictions'
      .replace('{namespace}', this.namespace)
  ...
  getAgerestrictionCountry_ByCountryCode_v3(countryCode: string): Promise<Response<CountryV3Response>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/agerestrictions/countries/{countryCode}'
      .replace('{namespace}', this.namespace)
      .replace('{countryCode}', countryCode)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getPlatformJustice_ByUserId_ByTargetNamespace(userId: string, targetNamespace: string): Promise<Response<GetUserMapping>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/platforms/justice/{targetNamespace}'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
  ...
  getWebLinkMeUsers_ByPlatformId_v3(
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/me/platforms/{platformId}/web/link'
      .replace('{namespace}', this.namespace)
      .replace('{platformId}', platformId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  deleteLink_ByUserId_ByPlatformId_v2(
    ...
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v2/public/namespaces/{namespace}/users/{userId}/platforms/{platformId}/link'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
      .replace('{platformId}', platformId)
    const resultPromise = this.axiosInstance.delete(url, { data, params })
  ...
  createPlatformLinkWithProgression_ByUserId_v3(
    ...
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/{userId}/platforms/linkWithProgression'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  createUserMePlatformJustice_ByTargetNamespace_v3(targetNamespace: string): Promise<Response<CreateJusticeUserResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/me/platforms/justice/{targetNamespace}'
      .replace('{namespace}', this.namespace)
      .replace('{targetNamespace}', targetNamespace)
    const resultPromise = this.axiosInstance.post(url, null, { params })
  ...
  getUser_ByPlatformId_ByPlatformUserId_v3(platformId: string, platformUserId: string): Promise<Response<UserResponseV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/platforms/{platformId}/users/{platformUserId}'
      .replace('{namespace}', this.namespace)
      .replace('{platformId}', platformId)
  ...
  updateUpgradeHeadlessAccountWithVerificationCode_ByUserId(
    ...
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/namespaces/{namespace}/users/{userId}/upgradeHeadlessAccountWithVerificationCode'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  postWebLinkProcesMeUser_ByPlatformId_v3(
    ...
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/me/platforms/{platformId}/web/link/process'
      .replace('{namespace}', this.namespace)
      .replace('{platformId}', platformId)
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
  ...
  getWebLinkEstablishMeUsers_ByPlatformId_v3(
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/public/namespaces/{namespace}/users/me/platforms/{platformId}/web/link/establish'
      .replace('{namespace}', this.namespace)
      .replace('{platformId}', platformId)
    const resultPromise = this.axiosInstance.get(url, { params })
