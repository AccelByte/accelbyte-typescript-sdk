...
export class UsersV4$ {
  ...
  createUserInvite_v4(data: PublicInviteUserRequestV4): Promise<Response<InviteUserResponseV3>> {
    ...
    const url = '/iam/iam/v4/public/users/invite'
  ...
  createUser_v4(data: CreateUserRequestV4): Promise<Response<CreateUserResponseV4>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  patchUserMe_v4(data: PublicUserUpdateRequestV3): Promise<Response<UserResponseV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/me'.replace('{namespace}', this.namespace)
  ...
  createTestUser_v4(data: CreateTestUserRequestV4): Promise<Response<CreateUserResponseV4>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/test_users'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  getUser_ByUserId_v4(userId: string): Promise<Response<UserPublicInfoResponseV4>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/{userId}'
  ...
  updateUserMeEmail_v4(data: EmailUpdateRequestV4): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/me/email'.replace('{namespace}', this.namespace)
   ...
   */
  createUserMeHeadlesCodeVerifyForward_v4(data: UpgradeHeadlessAccountWithVerificationCodeForwardRequestV4): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/users/me/headless/code/verify/forward'
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  deleteUserMeMfaDevice_v4(): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/me/mfa/device'.replace('{namespace}', this.namespace)
  ...
  getUsersMeMfaFactor_v4(): Promise<Response<EnabledFactorsResponseV4>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/me/mfa/factor'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getUsersMeMfaStatus_v4(): Promise<Response<UserMfaStatusResponseV4>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/me/mfa/status'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getUsersMeMfaBackupCode_v4(): Promise<Response<BackupCodesResponseV4>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCode'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  postUserMeMfaEmailCode_v4(data: { action?: string | null; languageTag?: string | null }): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/me/mfa/email/code'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  createUserMeHeadlesVerify_v4(data: UpgradeHeadlessAccountRequestV4): Promise<Response<UserResponseV4>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/me/headless/verify'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  getUsersMeMfaBackupCodes_v4(queryParams?: { languageTag?: string | null }): Promise<Response<unknown>> {
    ...
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCodes'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  postUserMeMfaEmailEnable_v4(data: { code: string | null }): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/me/mfa/email/enable'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  createUserMeMfaEmailDisable_v4(data: DisableMfaRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/me/mfa/email/disable'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  createUserInvite_ByInvitationId_v4(invitationId: string, data: CreateUserRequestV4): Promise<Response<CreateUserResponseV4>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/invite/{invitationId}'
      .replace('{namespace}', this.namespace)
  ...
  createUser_ByPlatformId_v4(
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/platforms/{platformId}/users'
      .replace('{namespace}', this.namespace)
  ...
  createUserMeHeadlesCodeVerify_v4(data: UpgradeHeadlessAccountWithVerificationCodeRequestV4): Promise<Response<UserResponseV4>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/me/headless/code/verify'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  postUserMeMfaChallengeVerify_v4(data: { code?: string | null; factor?: string | null }): Promise<Response<UserMfaTokenResponseV4>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/me/mfa/challenge/verify'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  createUserMeMfaAuthenticatorKey_v4(): Promise<Response<AuthenticatorKeyResponseV4>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/me/mfa/authenticator/key'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, null, { params })
  ...
  createUserMeMfaBackupCodeEnable_v4(): Promise<Response<BackupCodesResponseV4>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCode/enable'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, null, { params })
  ...
  deleteUserMeMfaBackupCodeDisable_v4(data: DisableMfaRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCode/disable'.replace('{namespace}', this.namespace)
  ...
  createUserMeMfaBackupCodeEnable_ByNS_v4(queryParams?: { languageTag?: string | null }): Promise<Response<unknown>> {
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCodes/enable'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, null, { params })
  ...
  getUsersMeMfaBackupCodeDownload_v4(): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCode/download'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  postUserMeMfaAuthenticatorEnable_v4(data: { code: string | null }): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/me/mfa/authenticator/enable'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  deleteUserMeMfaAuthenticatorDisable_v4(data: DisableMfaRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/users/me/mfa/authenticator/disable'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.delete(url, { data, params })
   ...
   */
  getUser_ByPlatformId_ByPlatformUserId_v4(platformId: string, platformUserId: string): Promise<Response<UserResponseV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/public/namespaces/{namespace}/platforms/{platformId}/users/{platformUserId}'
      .replace('{namespace}', this.namespace)
      .replace('{platformId}', platformId)
