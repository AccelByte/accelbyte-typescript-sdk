...
export class OAuth20V4$ {
  ...
  postOauthToken_v4(
    ...
    const url = '/iam/iam/v4/oauth/token'
  ...
  postOauthMfaVerify_v4(data: {
    ...
    const url = '/iam/iam/v4/oauth/mfa/verify'
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  postOauthHeadlesToken_v4(data: {
    ...
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/oauth/headless/token'
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  postOauthTokenExchange_v4(data: { code: string | null; additionalData?: string | null }): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/oauth/token/exchange'
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  postOauthSimultaneousLogin_v4(
    ...
    const params = { code_challenge_method: 'plain', ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v4/oauth/simultaneousLogin'
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  postOauthAuthenticateWithLink_v4(data: {
    ...
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/oauth/authenticateWithLink'
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  postTokenOauth_ByPlatformId_v4(
    ...
    const params = { code_challenge_method: 'plain', ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v4/oauth/platforms/{platformId}/token'.replace('{platformId}', platformId)
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
