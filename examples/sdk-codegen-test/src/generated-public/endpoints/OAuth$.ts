...
export class OAuth$ {
  ...
  postOauthVerify(data: { token: string | null }): Promise<Response<TokenResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/oauth/verify'
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  postOauthAuthorize(data: {
    ...
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/oauth/authorize'
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  postOauthRevokeUser(data: { userID: string | null }): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/oauth/revoke/user'
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  postOauthRevokeToken(data: { token: string | null }): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/oauth/revoke/token'
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  getOauthRevocationlist(): Promise<Response<RevocationList>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/oauth/revocationlist'
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  updateRevokeOauth_ByUserId(userId: string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/oauth/namespaces/{namespace}/users/{userId}/revoke'
  ...
  postTokenOauth_ByPlatformId(
    ...
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/oauth/namespaces/{namespace}/platforms/{platformId}/token'
      .replace('{namespace}', this.namespace)
