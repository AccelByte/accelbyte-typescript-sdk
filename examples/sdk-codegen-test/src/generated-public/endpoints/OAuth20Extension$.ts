...
export class OAuth20Extension$ {
  ...
  postAuthenticate_v3(data: {
    ...
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/authenticate'
  ...
  postHeadlesToken_v3(data: {
    ...
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/headless/token'
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  postTokenExchange_v3(data: { code: string | null; additionalData?: string | null }): Promise<Response<TokenResponseV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/token/exchange'
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  postUpgradeForward_v3(data: { client_id: string | null; upgrade_success_token: string | null }): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/upgrade/forward'
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  getLocationCountry_v3(): Promise<Response<CountryLocationResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/location/country'
  ...
  postLinkCodeRequest_v3(data: {
    ...
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/link/code/request'
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  postLinkCodeValidate_v3(data: { oneTimeLinkCode: string | null }): Promise<Response<OneTimeLinkingCodeValidationResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/link/code/validate'
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  postLinkTokenExchange_v3(data: {
    ...
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/link/token/exchange'
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  postAuthenticateWithLink_v3(data: {
    ...
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/authenticateWithLink'
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  postAuthenticateWithLinkForward_v3(data: {
    ...
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/authenticateWithLink/forward'
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  postTokenRequest_v3(
    ...
    const url = '/iam/iam/v3/namespace/{namespace}/token/request'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
  ...
  getAuthenticate_ByPlatformId_v3(
    ...
    const url = '/iam/iam/v3/platforms/{platformId}/authenticate'.replace('{platformId}', platformId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  postTokenVerify_ByPlatformId_v3(
    ...
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/platforms/{platformId}/token/verify'.replace('{platformId}', platformId)
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
      ...params,
      headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' }
    })
