...
export class UsersAdmin$ {
  ...
  getUsersMe_v3(): Promise<Response<UserResponseV3>> {
    ...
    const url = '/iam/iam/v3/admin/users/me'
  ...
  getUsers_v2(queryParams: {
    ...
    const url = '/iam/iam/v2/admin/namespaces/{namespace}/users'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getUsers_v3(queryParams?: { emailAddress?: string | null }): Promise<Response<UserResponseV3>> {
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getAdmins_v3(queryParams?: {
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/admins'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  fetchUserBan_v3(
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/bans'.replace('{namespace}', this.namespace)
  ...
  createUserBulk_v3(data: AdminBulkUserRequest): Promise<Response<ListUserInformationResult>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/bulk'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  fetchUserCursor_v3(data: CursorGetUserRequest): Promise<Response<CursorGetUserResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/cursor'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  createUserInvite_v3(data: InviteUserRequestV3): Promise<Response<InviteUserResponseV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/invite'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  getUsersSearch_v3(queryParams?: {
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/search'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getUser_ByUserId_v2(userId: string): Promise<Response<UserResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v2/admin/namespaces/{namespace}/users/{userId}'.replace('{namespace}', this.namespace).replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getUser_ByUserId_v3(userId: string): Promise<Response<UserResponseV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}'.replace('{namespace}', this.namespace).replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getAgerestrictions_v2(): Promise<Response<AgeRestrictionResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v2/admin/namespaces/{namespace}/agerestrictions'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getAgerestrictions_v3(): Promise<Response<AgeRestrictionResponseV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/agerestrictions'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  fetchUserSearchBulk_v3(data: ListEmailAddressRequest): Promise<Response<ListUserResponseV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/search/bulk'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  createBan_ByUserId_v2(userId: string, data: BanCreateRequest): Promise<Response<UserBanResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v2/admin/namespaces/{namespace}/users/{userId}/ban'
  ...
  getBans_ByUserId_v2(userId: string, queryParams?: { activeOnly?: boolean | null }): Promise<Response<UserBanResponseArray>> {
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v2/admin/namespaces/{namespace}/users/{userId}/bans'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getBans_ByUserId_v3(
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/bans'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getUsersLinkhistories_v3(queryParams: {
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/linkhistories'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  updateRole_ByUserId_v2(userId: string, data: string[]): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v2/admin/namespaces/{namespace}/users/{userId}/roles'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  getUsers_ByRoleId_v3(
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/roles/{roleId}/users'
      .replace('{namespace}', this.namespace)
  ...
  getCodes_ByUserId_v3(userId: string): Promise<Response<VerificationCodeResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/codes'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  deleteRole_ByUserId_v3(userId: string, data: string[]): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/roles'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
  ...
  getState_ByUserId_v3(userId: string): Promise<Response<UserStateResponseV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/state'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  fetchUserBulkPlatform_v3(data: UserIDsRequest): Promise<Response<ListBulkUserPlatformsResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/bulk/platforms'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  updateEnable_ByUserId_v2(userId: string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v2/admin/namespaces/{namespace}/users/{userId}/enable'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
  ...
  patchStatus_ByUserId_v3(userId: string, data: UpdateUserStatusRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/status'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.patch(url, data, { params })
  ...
  updateVerify_ByUserId_v3(userId: string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/verify'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.put(url, null, { params })
  ...
  updateDisable_ByUserId_v2(userId: string, data: DisableUserRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v2/admin/namespaces/{namespace}/users/{userId}/disable'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.put(url, data, { params })
  ...
  patchCountry_ByCountryCode_v2(countryCode: string, data: CountryAgeRestrictionRequest): Promise<Response<Country>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v2/admin/namespaces/{namespace}/countries/{countryCode}'
      .replace('{namespace}', this.namespace)
  ...
  updatePassword_ByUserId_v2(userId: string, data: UserPasswordUpdateRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v2/admin/namespaces/{namespace}/users/{userId}/password'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.put(url, data, { params })
  ...
  updatePassword_ByUserId_v3(userId: string, data: UserPasswordUpdateV3Request): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/password'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.put(url, data, { params })
  ...
  getUsersPlatformsJustice_v3(queryParams?: { limit?: number; offset?: number }): Promise<Response<ListUsersWithPlatformAccountsResponse>> {
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/platforms/justice'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getPlatforms_ByUserId_v3(
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getCountriesAgerestrictions_v2(): Promise<Response<CountryAgeRestrictionArray>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v2/admin/namespaces/{namespace}/countries/agerestrictions'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getAgerestrictionsCountries_v3(): Promise<Response<CountryV3ResponseArray>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/agerestrictions/countries'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  updateCodeVerify_ByUserId_v3(userId: string, data: UserVerificationRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/code/verify'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  deleteInformation_ByUserId_v3(userId: string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/information'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
  ...
  deletePermission_ByUserId_v3(userId: string, data: PermissionDeleteRequest[]): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/permissions'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.delete(url, { data, params })
  ...
  patchBan_ByUserId_ByBanId_v3(userId: string, banId: string, data: BanUpdateRequest): Promise<Response<UserBanResponseV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/bans/{banId}'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
      .replace('{banId}', banId)
    const resultPromise = this.axiosInstance.patch(url, data, { params })
  ...
  getBansSummary_ByUserId_v3(userId: string): Promise<Response<GetUserBanSummaryV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/bans/summary'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  updateCodeRequest_ByUserId_v3(userId: string, data: SendVerificationCodeRequestV3): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/code/request'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  fetchUser_ByPlatformId_v3(
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/platforms/{platformId}/users'
      .replace('{namespace}', this.namespace)
  ...
  updatePlatformLink_ByUserId_v3(
    ...
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/link'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  deleteRole_ByUserId_ByRoleId_v3(userId: string, roleId: string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/roles/{roleId}'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
      .replace('{roleId}', roleId)
    const resultPromise = this.axiosInstance.delete(url, { params })
  ...
  getDeletionStatus_ByUserId_v3(userId: string): Promise<Response<UserDeletionStatusResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/deletion/status'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getLoginsHistories_ByUserId_v3(
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/logins/histories'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  patchTrustlyIdentity_ByUserId_v3(userId: string, data: UserIdentityUpdateRequestV3): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/trustly/identity'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.patch(url, data, { params })
  ...
  getDistinctPlatforms_ByUserId_v3(userId: string): Promise<Response<DistinctPlatformResponseV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/distinctPlatforms'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getPlatformsJustice_ByUserId_v3(userId: string): Promise<Response<GetUserMappingArray>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/justice'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getPlatformsDistinct_ByUserId_v3(
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/distinct'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  updateHeadlesCodeVerify_ByUserId_v3(
    ...
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/headless/code/verify'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  deletePlatform_ByUserId_ByPlatformId_v3(userId: string, platformId: string, data: UnlinkUserPlatformRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/{platformId}'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
      .replace('{platformId}', platformId)
    const resultPromise = this.axiosInstance.delete(url, { data, params })
  ...
  patchAgerestrictionCountry_ByCountryCode_v3(
    ...
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/agerestrictions/countries/{countryCode}'
      .replace('{namespace}', this.namespace)
      .replace('{countryCode}', countryCode)
    const resultPromise = this.axiosInstance.patch(url, data, { params })
  ...
  getPlatformsLinkHistories_ByUserId_v3(
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/link/histories'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  deleteAll_ByUserId_ByPlatformId_v3(userId: string, platformId: string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/{platformId}/all'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
      .replace('{platformId}', platformId)
    const resultPromise = this.axiosInstance.delete(url, { params })
  ...
  deleteLink_ByUserId_ByPlatformId_v2(
    ...
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v2/admin/namespaces/{namespace}/users/{userId}/platforms/{platformId}/link'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
      .replace('{platformId}', platformId)
    const resultPromise = this.axiosInstance.delete(url, { data, params })
  ...
  postLink_ByUserId_ByPlatformId_v3(userId: string, platformId: string, data: { ticket: string | null }): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/{platformId}/link'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
      .replace('{platformId}', platformId)
  ...
  getUser_ByPlatformId_ByPlatformUserId_v3(
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/platforms/{platformId}/users/{platformUserId}'
      .replace('{namespace}', this.namespace)
      .replace('{platformId}', platformId)
  ...
  deletePermission_ByUserId_ByResource_ByAction_v3(userId: string, resource: string, action: number): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/permissions/{resource}/{action}'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
  ...
  getMetadata_ByUserId_ByPlatformId_v3(
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/{platformId}/metadata'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
      .replace('{platformId}', platformId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  postLinkStatu_ByUserId_ByPlatformId_v3(
    ...
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/{platformId}/linkStatus'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
      .replace('{platformId}', platformId)
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), {
  ...
  getPlatformJustice_ByUserId_ByTargetNamespace_v3(userId: string, targetNamespace: string): Promise<Response<GetUserMappingV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/justice/{targetNamespace}'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
  ...
  deleteLinkHistory_ByUserId_ByPlatformId_v3(userId: string, platformId: string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/{platformId}/link/histories'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
      .replace('{platformId}', platformId)
    const resultPromise = this.axiosInstance.delete(url, { params })
  ...
  deleteLinkRestriction_ByUserId_ByPlatformId_v3(userId: string, platformId: string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/{platformId}/link/restrictions'
      .replace('{namespace}', this.namespace)
      .replace('{userId}', userId)
      .replace('{platformId}', platformId)
    const resultPromise = this.axiosInstance.delete(url, { params })
