...
export class CountryAdmin$ {
  ...
  getCountries_v3(queryParams?: { filterBlacklist?: boolean | null }): Promise<Response<CountryResponseArray>> {
    ...
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/countries'.replace('{namespace}', this.namespace)
  ...
  getCountriesBlacklist_v3(): Promise<Response<CountryBlacklistResponse>> {
    ...
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/countries/blacklist'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
