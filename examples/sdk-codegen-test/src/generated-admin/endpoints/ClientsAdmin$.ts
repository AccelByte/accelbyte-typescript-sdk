...
export class ClientsAdmin$ {
  ...
  getClients_v3(queryParams?: {
    ...
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/clients'.replace('{namespace}', this.namespace)
  ...
  updateSecret_ByClientId_v3(clientId: string, data: V3ClientUpdateSecretRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/{clientId}/secret'
  ...
  deleteClient_ByClientId_v3(clientId: string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/clients/{clientId}'
      .replace('{namespace}', this.namespace)
      .replace('{clientId}', clientId)
  ...
  updatePermission_ByClientId_v3(clientId: string, data: ClientPermissionsV3): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/clients/{clientId}/permissions'
      .replace('{namespace}', this.namespace)
      .replace('{clientId}', clientId)
    const resultPromise = this.axiosInstance.post(url, data, { params })
  ...
  deletePermission_ByClientId_ByResource_ByAction_v3(clientId: string, resource: string, action: number): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/clients/{clientId}/permissions/{resource}/{action}'
      .replace('{namespace}', this.namespace)
      .replace('{clientId}', clientId)
