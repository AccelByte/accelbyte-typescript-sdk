...
export class BansAdmin$ {
  ...
  getBans_v3(): Promise<Response<BansV3>> {
    ...
    const url = '/iam/iam/v3/admin/bans'
  ...
  getBansReasons_v3(): Promise<Response<BanReasonsV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/bans/reasons'
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getBantypes_v3(): Promise<Response<BansV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/bantypes'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getBansUsers_v3(queryParams?: {
    ...
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/bans/users'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  patchBanUserDisabled_v3(data: BulkUnbanCreateRequestV3): Promise<Response<ListBulkUserBanResponseV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v3/admin/namespaces/{namespace}/bans/users/disabled'.replace('{namespace}', this.namespace)
