...
export class DevicesV4Admin$ {
  ...
  getDevices_v4(queryParams?: { userId?: string | null }): Promise<Response<DevicesResponseV4>> {
    ...
    const url = '/iam/iam/v4/admin/namespaces/{namespace}/devices'.replace('{namespace}', this.namespace)
  ...
  getDevicesBans_v4(queryParams: { userId: string | null }): Promise<Response<DeviceBansResponseV4>> {
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v4/admin/namespaces/{namespace}/devices/bans'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getDevicesTypes_v4(): Promise<Response<DeviceTypesResponseV4>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/admin/namespaces/{namespace}/devices/types'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getDevicesBanned_v4(queryParams?: {
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v4/admin/namespaces/{namespace}/devices/banned'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getDevicesReport_v4(queryParams: {
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/iam/iam/v4/admin/namespaces/{namespace}/devices/report'.replace('{namespace}', this.namespace)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getDeviceBan_ByBanId_v4(banId: string): Promise<Response<DeviceBanResponseV4>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/admin/namespaces/{namespace}/devices/bans/{banId}'
  ...
  getBans_ByDeviceId_v4(deviceId: string): Promise<Response<DeviceBansResponseV4>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/admin/namespaces/{namespace}/devices/{deviceId}/bans'
      .replace('{namespace}', this.namespace)
  ...
  updateUnban_ByDeviceId_v4(deviceId: string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/admin/namespaces/{namespace}/devices/{deviceId}/unban'
      .replace('{namespace}', this.namespace)
      .replace('{deviceId}', deviceId)
  ...
  getUsers_ByDeviceId_v4(deviceId: string): Promise<Response<DeviceUsersResponseV4>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/admin/namespaces/{namespace}/devices/{deviceId}/users'
      .replace('{namespace}', this.namespace)
      .replace('{deviceId}', deviceId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getDecrypt_ByDeviceId_v4(deviceId: string): Promise<Response<DeviceIdDecryptResponseV4>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/iam/v4/admin/namespaces/{namespace}/devices/{deviceId}/decrypt'
      .replace('{namespace}', this.namespace)
      .replace('{deviceId}', deviceId)
    const resultPromise = this.axiosInstance.get(url, { params })
